...
{13,4130,1,0,0,
5,0,0,1,186,0,4,33,0,0,9,1,0,2,7,79,82,65,67,76,69,50,2,97,0,0,2,97,0,0,2,3,0,
0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,3,0,0,1,97,0,0,
};
...
// Agrega esta línea justo antes del INCLUDE:
...

{
    ...
    sqlstm.stmt = "select genero ,etapa ,pies ,pulgadas ,descripcion ,TO_CHA\
R(fecha_tag,'YYYY-MM-DD HH24:MI:SS') ,lugar_tag ,id_especie into :b0,:b1,:b2,:\
b3,:b4,:b5,:b6,:b7  from tiburones where nombre=:b8";
    ...
    sqlstm.sqhstv[0] = (unsigned char  *)h_genero;
    ...
    sqlstm.sqhstv[1] = (unsigned char  *)h_etapa;
    ...
    sqlstm.sqhstv[2] = (unsigned char  *)&h_pies;
    ...
    sqlstm.sqhstv[3] = (unsigned char  *)&h_pulgadas;
    ...
    sqlstm.sqhstv[4] = (unsigned char  *)h_descripcion;
    ...
    sqlstm.sqhstv[5] = (unsigned char  *)h_fecha_tag;
    ...
    sqlstm.sqhstv[6] = (unsigned char  *)h_lugar_tag;
    ...
    sqlstm.sqhstv[7] = (unsigned char  *)&h_id_especie;
    ...
    sqlstm.sqhstv[8] = (unsigned char  *)h_nombre;
    ...
    if (sqlca.sqlcode < 0) sqlError("Error al realizar SELECT en tiburones");
}
